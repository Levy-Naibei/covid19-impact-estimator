...
def estimator():
    ...
    currently_infected_impact = reported_cases * 10
    currently_infected_severe = reported_cases * 50
    ...
    dollars_in_flight_impact = infections_by_requested_time_impact * avg_daily_income_USD * time_to_elapse
    dollars_in_flight_severe = infections_by_requested_time_severe * avg_daily_income_USD * time_to_elapse
