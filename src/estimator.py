...
def estimator(data):
    ...
    daily_income_population = data['region']['avgDailyIncomePopulation']
    ...
    # dollarsInFlight
    impact['dollarsInFlight'] = int((impact['infectionsByRequestedTime'] * daily_income_population * daily_income) / time_to_elapse)
    severe_impact['dollarsInFlight'] = int((severe_impact['infectionsByRequestedTime'] * daily_income_population * daily_income) / time_to_elapse)
