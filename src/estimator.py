...
def estimator(data):
    ...
    infections_by_requested_time_impact = int(currently_infected_impact * int(time_to_elapse))
    infections_by_requested_time_severe = int(currently_infected_severe * int(time_to_elapse))
